"""The module defines various helper methods used by the application."""
...
from app.github_query.github_graphql.query import Query
...
def get_abs_path(file_name: str) -> str:
    """
    Constructs and returns the absolute path for a given file name,
    assuming the file is in the 'query_result' directory.
